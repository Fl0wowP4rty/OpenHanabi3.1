...
public abstract class BooleanPropertyBase extends BooleanProperty {
   ...
   public BooleanPropertyBase(boolean var1) {
      this.value = var1;
   }
   ...
   public void bind(final ObservableValue var1) {
      if (var1 == null) {
         ...
         Object var2 = var1 instanceof ObservableBooleanValue ? (ObservableBooleanValue)var1 : new BooleanBinding() {
            {
               super.bind(var1);
            }

            protected boolean computeValue() {
               Boolean var1x = (Boolean)var1.getValue();
               return var1x == null ? false : var1x;
            }
         };
         if (!var2.equals(this.observable)) {
            this.unbind();
            this.observable = (ObservableBooleanValue)var2;
   ...
   private static class Listener implements InvalidationListener {
      ...
      public Listener(BooleanPropertyBase var1) {
         this.wref = new WeakReference(var1);
      }

      public void invalidated(Observable var1) {
         BooleanPropertyBase var2 = (BooleanPropertyBase)this.wref.get();
         if (var2 == null) {
