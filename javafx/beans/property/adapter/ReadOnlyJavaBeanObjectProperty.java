...
public final class ReadOnlyJavaBeanObjectProperty extends ReadOnlyObjectPropertyBase implements ReadOnlyJavaBeanProperty {
   private final ReadOnlyPropertyDescriptor descriptor;
   private final ReadOnlyPropertyDescriptor.ReadOnlyListener listener;
   private final AccessControlContext acc = AccessController.getContext();

   ReadOnlyJavaBeanObjectProperty(ReadOnlyPropertyDescriptor var1, Object var2) {
   ...
   public Object get() {
      return AccessController.doPrivileged(() -> {
         try {
            return MethodUtil.invoke(this.descriptor.getGetter(), this.getBean(), (Object[])null);
