...
public final class ReadOnlyJavaBeanStringProperty extends ReadOnlyStringPropertyBase implements ReadOnlyJavaBeanProperty {
   private final ReadOnlyPropertyDescriptor descriptor;
   private final ReadOnlyPropertyDescriptor.ReadOnlyListener listener;
   private final AccessControlContext acc = AccessController.getContext();

   ReadOnlyJavaBeanStringProperty(ReadOnlyPropertyDescriptor var1, Object var2) {
   ...
   public String get() {
      return (String)AccessController.doPrivileged(() -> {
         try {
            return (String)MethodUtil.invoke(this.descriptor.getGetter(), this.getBean(), (Object[])null);
