...
public final class JavaBeanLongProperty extends LongProperty implements JavaBeanProperty {
   ...
   JavaBeanLongProperty(PropertyDescriptor var1, Object var2) {
   ...
   public long get() {
      return (Long)AccessController.doPrivileged(() -> {
         try {
            return ((Number)MethodUtil.invoke(this.descriptor.getGetter(), this.getBean(), (Object[])null)).longValue();
   ...
   public void bind(ObservableValue var1) {
      if (var1 == null) {
         ...
         if (!var1.equals(this.observable)) {
            this.unbind();
            this.set(((Number)var1.getValue()).longValue());
