...
public final class JavaBeanDoubleProperty extends DoubleProperty implements JavaBeanProperty {
   ...
   JavaBeanDoubleProperty(PropertyDescriptor var1, Object var2) {
   ...
   public double get() {
      return (Double)AccessController.doPrivileged(() -> {
         try {
            return ((Number)MethodUtil.invoke(this.descriptor.getGetter(), this.getBean(), (Object[])null)).doubleValue();
   ...
   public void bind(ObservableValue var1) {
      if (var1 == null) {
         ...
         if (!var1.equals(this.observable)) {
            this.unbind();
            this.set(((Number)var1.getValue()).doubleValue());
