...
public final class JavaBeanIntegerProperty extends IntegerProperty implements JavaBeanProperty {
   ...
   JavaBeanIntegerProperty(PropertyDescriptor var1, Object var2) {
   ...
   public void bind(ObservableValue var1) {
      if (var1 == null) {
         ...
         if (!var1.equals(this.observable)) {
            this.unbind();
            this.set(((Number)var1.getValue()).intValue());
