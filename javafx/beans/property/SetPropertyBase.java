...
public abstract class SetPropertyBase extends SetProperty {
   private final SetChangeListener setChangeListener = (var1x) -> {
   ...
   public SetPropertyBase(ObservableSet var1) {
      this.value = var1;
      if (var1 != null) {
         var1.addListener(this.setChangeListener);
      }
   ...
   private void markInvalid(ObservableSet var1) {
      if (this.valid) {
         if (var1 != null) {
            var1.removeListener(this.setChangeListener);
         }
   ...
   public void set(ObservableSet var1) {
      if (!this.isBound()) {
         if (this.value != var1) {
            ObservableSet var2 = this.value;
            this.value = var1;
   ...
   public String toString() {
      ...
      StringBuilder var3 = new StringBuilder("SetProperty [");
      if (var1 != null) {
   ...
   private static class Listener implements InvalidationListener {
      ...
      public Listener(SetPropertyBase var1) {
         this.wref = new WeakReference(var1);
      }

      public void invalidated(Observable var1) {
         SetPropertyBase var2 = (SetPropertyBase)this.wref.get();
         if (var2 == null) {
