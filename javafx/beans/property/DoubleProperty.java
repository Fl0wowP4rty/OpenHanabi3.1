...
public abstract class DoubleProperty extends ReadOnlyDoubleProperty implements Property, WritableDoubleValue {
   ...
   public static DoubleProperty doubleProperty(final Property var0) {
      if (var0 == null) {
         ...
         return new DoublePropertyBase() {
            ...
            {
               BidirectionalBinding.bindNumber((DoubleProperty)this, (Property)var0);
            }
   ...
   public ObjectProperty asObject() {
      return new ObjectPropertyBase() {
         ...
         {
            BidirectionalBinding.bindNumber((Property)this, (DoubleProperty)DoubleProperty.this);
         }
