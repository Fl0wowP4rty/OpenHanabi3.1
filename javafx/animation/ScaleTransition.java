...
public final class ScaleTransition extends Transition {
   ...
   public ScaleTransition(Duration var1, Node var2) {
      this.setDuration(var1);
      this.setNode(var2);
      this.setCycleDuration(var1);
   }

   public ScaleTransition(Duration var1) {
      this(var1, (Node)null);
   }
   ...
   public void interpolate(double var1) {
      if (!Double.isNaN(this.startX)) {
         this.cachedNode.setScaleX(this.startX + var1 * this.deltaX);
      }

      if (!Double.isNaN(this.startY)) {
         this.cachedNode.setScaleY(this.startY + var1 * this.deltaY);
      }

      if (!Double.isNaN(this.startZ)) {
         this.cachedNode.setScaleZ(this.startZ + var1 * this.deltaZ);
      }
   ...
   void impl_sync(boolean var1) {
      ...
      if (var1 || this.cachedNode == null) {
         ...
         if (Double.isNaN(var2) && Double.isNaN(var8) && Math.abs(var14) < 1.0E-12) {
            ...
            this.startX = !Double.isNaN(var2) ? var2 : this.cachedNode.getScaleX();
            this.deltaX = !Double.isNaN(var8) ? var8 - this.startX : this.getByX();
         }

         if (Double.isNaN(var4) && Double.isNaN(var10) && Math.abs(var16) < 1.0E-12) {
            this.startY = Double.NaN;
         } else {
            this.startY = !Double.isNaN(var4) ? var4 : this.cachedNode.getScaleY();
         ...
         if (Double.isNaN(var6) && Double.isNaN(var12) && Math.abs(var18) < 1.0E-12) {
            ...
            this.startZ = !Double.isNaN(var6) ? var6 : this.cachedNode.getScaleZ();
