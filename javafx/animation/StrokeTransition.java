...
public final class StrokeTransition extends Transition {
   ...
   public StrokeTransition(Duration var1, Shape var2, Color var3, Color var4) {
   ...
   public StrokeTransition(Duration var1, Color var2, Color var3) {
      this(var1, (Shape)null, var2, var3);
   }

   public StrokeTransition(Duration var1, Shape var2) {
      this(var1, var2, (Color)null, (Color)null);
   }

   public StrokeTransition(Duration var1) {
      this(var1, (Shape)null);
   }
   ...
   protected void interpolate(double var1) {
      ...
      this.cachedShape.setStroke(var3);
   }
   ...
   boolean impl_startable(boolean var1) {
      if (!super.impl_startable(var1)) {
         ...
         return var2 != null && (this.getFromValue() != null || var2.getStroke() instanceof Color) && this.getToValue() != null;
      }
   }
   ...
   void impl_sync(boolean var1) {
      ...
      if (var1 || this.cachedShape == null) {
         ...
         this.start = var2 != null ? var2 : (Color)this.cachedShape.getStroke();
