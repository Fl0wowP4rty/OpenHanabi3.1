...
public class LineTo extends PathElement {
   ...
   public LineTo(double var1, double var3) {
      this.setX(var1);
      this.setY(var3);
   }
   ...
   void addTo(NGPath var1) {
      if (this.isAbsolute()) {
         var1.addLineTo((float)this.getX(), (float)this.getY());
      } else {
         var1.addLineTo((float)((double)var1.getCurrentX() + this.getX()), (float)((double)var1.getCurrentY() + this.getY()));
      }
   ...
   public void impl_addTo(Path2D var1) {
      if (this.isAbsolute()) {
         var1.lineTo((float)this.getX(), (float)this.getY());
      } else {
         var1.lineTo((float)((double)var1.getCurrentX() + this.getX()), (float)((double)var1.getCurrentY() + this.getY()));
      }

   }

   public String toString() {
      StringBuilder var1 = new StringBuilder("LineTo[");
