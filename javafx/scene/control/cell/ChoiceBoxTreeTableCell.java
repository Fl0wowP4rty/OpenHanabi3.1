...
public class ChoiceBoxTreeTableCell extends TreeTableCell {
   ...
   public static Callback forTreeTableColumn(StringConverter var0, ObservableList var1) {
      return (var2) -> {
         return new ChoiceBoxTreeTableCell(var0, var1);
      };
   }
   ...
   @SafeVarargs
   public ChoiceBoxTreeTableCell(Object... var1) {
      this(FXCollections.observableArrayList(var1));
   }

   @SafeVarargs
   public ChoiceBoxTreeTableCell(StringConverter var1, Object... var2) {
      this(var1, FXCollections.observableArrayList(var2));
   }

   public ChoiceBoxTreeTableCell(ObservableList var1) {
      this((StringConverter)null, (ObservableList)var1);
   }

   public ChoiceBoxTreeTableCell(StringConverter var1, ObservableList var2) {
