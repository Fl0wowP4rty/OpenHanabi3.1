...
public class ComboBoxTableCell extends TableCell {
   ...
   public static Callback forTableColumn(StringConverter var0, ObservableList var1) {
      return (var2) -> {
         return new ComboBoxTableCell(var0, var1);
      };
   }
   ...
   @SafeVarargs
   public ComboBoxTableCell(Object... var1) {
      this(FXCollections.observableArrayList(var1));
   }

   @SafeVarargs
   public ComboBoxTableCell(StringConverter var1, Object... var2) {
      this(var1, FXCollections.observableArrayList(var2));
   }

   public ComboBoxTableCell(ObservableList var1) {
      this((StringConverter)null, (ObservableList)var1);
   }

   public ComboBoxTableCell(StringConverter var1, ObservableList var2) {
