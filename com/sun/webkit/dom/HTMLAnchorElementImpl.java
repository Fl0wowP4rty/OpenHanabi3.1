...
public class HTMLAnchorElementImpl extends HTMLElementImpl implements HTMLAnchorElement {
   HTMLAnchorElementImpl(long var1) {
      super(var1);
   }

   static HTMLAnchorElement getImpl(long var0) {
      return (HTMLAnchorElement)create(var0);
   }
   ...
   public void setText(String var1) throws DOMException {
