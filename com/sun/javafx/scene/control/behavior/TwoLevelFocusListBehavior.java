...
public class TwoLevelFocusListBehavior extends TwoLevelFocusBehavior {
   ...
   final ChangeListener focusListener = (var1x, var2, var3) -> {
      if (var3 && this.tlPopup != null) {
         ...
         boolean var4 = true;
         if (this.tlNode != null) {
            Parent var5 = this.tlNode.getParent();
            if (var5 != null && "combo-box-popup".equals(var5.getStyleClass().toString())) {
               var4 = false;
            }
         }

         this.setExternalFocus(var4);
      }
   ...
   public TwoLevelFocusListBehavior(Node var1) {
      this.tlNode = var1;
