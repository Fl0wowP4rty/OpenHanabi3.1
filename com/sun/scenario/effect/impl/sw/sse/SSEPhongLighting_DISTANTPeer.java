...
public class SSEPhongLighting_DISTANTPeer extends SSEEffectPeer {
   ...
   public SSEPhongLighting_DISTANTPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      float[] var40 = this.getNormalizedLightPosition();
      float var41 = this.getSpecularConstant();
      float var42 = this.getSpecularExponent();
      filter(var35, 0, 0, var31, var32, var34, var13, var27[0], var27[1], var27[2], var27[3], var10, var11, var12, var36, var38, var39[0], var39[1], var39[2], var40[0], var40[1], var40[2], var23, var28[0], var28[1], var28[2], var28[3], var20, var21, var22, var41, var42);
