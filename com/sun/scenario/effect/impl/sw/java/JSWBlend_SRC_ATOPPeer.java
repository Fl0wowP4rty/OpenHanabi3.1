...
public class JSWBlend_SRC_ATOPPeer extends JSWEffectPeer {
   public JSWBlend_SRC_ATOPPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var84 = var80 * var79 + var58 * (1.0F - var83);
            float var85 = var81 * var79 + var59 * (1.0F - var83);
            float var68 = var82 * var79 + var78 * (1.0F - var83);
            float var69 = var83 * var79 + var79 * (1.0F - var83);
            float var37 = var84;
            float var38 = var85;
            float var39 = var68;
            float var40 = var69;
