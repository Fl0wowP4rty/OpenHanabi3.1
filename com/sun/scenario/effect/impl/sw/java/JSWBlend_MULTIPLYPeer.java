...
public class JSWBlend_MULTIPLYPeer extends JSWEffectPeer {
   public JSWBlend_MULTIPLYPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var80 = var54 * var41;
            float var81 = var55 * var41;
            float var82 = var56 * var41;
            float var83 = var57 * var41;
            float var84 = var58 * (var80 + 1.0F - var83) + var80 * (1.0F - var79);
            float var85 = var59 * (var81 + 1.0F - var83) + var81 * (1.0F - var79);
            float var68 = var78 * (var82 + 1.0F - var83) + var82 * (1.0F - var79);
            float var69 = var79 * (var83 + 1.0F - var83) + var83 * (1.0F - var79);
            float var37 = var84;
            float var38 = var85;
            float var39 = var68;
            float var40 = var69;
