...
public class JSWBlend_OVERLAYPeer extends JSWEffectPeer {
   public JSWBlend_OVERLAYPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var102 = var54 * var41;
            float var103 = var55 * var41;
            float var104 = var56 * var41;
            float var105 = var57 * var41;
            float var81 = var101 + var105 - var101 * var105;
            float var85 = var58 - var101 * 0.5F;
            float var86 = var59 - var101 * 0.5F;
            float var87 = var100 - var101 * 0.5F;
            float var82 = (float)Math.ceil((double)var85);
            float var83 = (float)Math.ceil((double)var86);
            float var84 = (float)Math.ceil((double)var87);
            float var91 = var58 - var82 * var101;
            float var92 = var59 - var83 * var101;
            float var93 = var100 - var84 * var101;
            float var88 = Math.abs(var91);
            float var89 = Math.abs(var92);
            float var90 = Math.abs(var93);
            var91 = var88;
            var92 = var89;
            var93 = var90;
            float var94 = var102 - var82 * var105;
            float var95 = var103 - var83 * var105;
            float var96 = var104 - var84 * var105;
            var88 = Math.abs(var94);
            var89 = Math.abs(var95);
            var90 = Math.abs(var96);
            float var78 = (2.0F * var91 + 1.0F - var101) * var88 + (1.0F - var105) * var91;
            float var79 = (2.0F * var92 + 1.0F - var101) * var89 + (1.0F - var105) * var92;
            float var80 = (2.0F * var93 + 1.0F - var101) * var90 + (1.0F - var105) * var93;
            float var97 = var78 - var82 * var81;
            float var98 = var79 - var83 * var81;
            float var99 = var80 - var84 * var81;
            var88 = Math.abs(var97);
            var89 = Math.abs(var98);
            var90 = Math.abs(var99);
            float var37 = var88;
            float var38 = var89;
            float var39 = var90;
            float var40 = var81;
