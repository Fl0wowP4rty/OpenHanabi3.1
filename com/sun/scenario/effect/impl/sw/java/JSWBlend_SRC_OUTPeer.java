...
public class JSWBlend_SRC_OUTPeer extends JSWEffectPeer {
   public JSWBlend_SRC_OUTPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var79 = var54 * var41;
            float var80 = var55 * var41;
            float var81 = var56 * var41;
            float var82 = var57 * var41;
            float var83 = var79 * (1.0F - var78);
            float var84 = var80 * (1.0F - var78);
            float var68 = var81 * (1.0F - var78);
            float var69 = var82 * (1.0F - var78);
            float var37 = var83;
            float var38 = var84;
            float var39 = var68;
            float var40 = var69;
