...
public class JSWBlend_COLOR_BURNPeer extends JSWEffectPeer {
   public JSWBlend_COLOR_BURNPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var81 = var88 + var92 - var88 * var92;
            float var78 = (1.0F - var92) * var58 + (1.0F - var88) * var89;
            float var79 = (1.0F - var92) * var59 + (1.0F - var88) * var90;
            float var80 = (1.0F - var92) * var87 + (1.0F - var88) * var91;
            float var82 = var88 * var92;
            float var83 = var92 * var92;
            float var84;
            if (var88 == var58) {
               var84 = var82;
            } else if (var89 == 0.0F) {
