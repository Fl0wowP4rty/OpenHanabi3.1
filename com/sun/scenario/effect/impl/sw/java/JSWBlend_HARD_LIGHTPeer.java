...
public class JSWBlend_HARD_LIGHTPeer extends JSWEffectPeer {
   public JSWBlend_HARD_LIGHTPeer(FilterContext var1, Renderer var2, String var3) {
   ...
   public ImageData filter(Effect var1, RenderState var2, BaseTransform var3, Rectangle var4, ImageData... var5) {
      ...
      for(int var48 = 0; var48 < 0 + var32; ++var48) {
         ...
         for(int var52 = 0; var52 < 0 + var31; ++var52) {
            ...
            float var85 = var54 * var41;
            float var86 = var55 * var41;
            float var87 = var56 * var41;
            float var88 = var57 * var41;
            float var81 = var84 + var88 - var84 * var88;
            float var82 = 0.5F * var88;
            float var78;
            if (var85 > var82) {
               var78 = var85 + var84 * (var85 - var88) - var58 * (2.0F * var85 - var88 - 1.0F);
            } else {
               var78 = 2.0F * var58 * var85 + var58 * (1.0F - var88) + var85 * (1.0F - var84);
            }

            float var79;
            if (var86 > var82) {
               var79 = var86 + var84 * (var86 - var88) - var59 * (2.0F * var86 - var88 - 1.0F);
            } else {
               var79 = 2.0F * var59 * var86 + var59 * (1.0F - var88) + var86 * (1.0F - var84);
            }

            float var80;
            if (var87 > var82) {
               var80 = var87 + var84 * (var87 - var88) - var83 * (2.0F * var87 - var88 - 1.0F);
            } else {
               var80 = 2.0F * var83 * var87 + var83 * (1.0F - var88) + var87 * (1.0F - var84);
            }
