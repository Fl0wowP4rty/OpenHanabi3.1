   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         if (this.getEnableBackgroundDrawing()) {
            RenderUtil.drawRect((float)this.xPosition - 0.5F, (float)this.yPosition - 0.5F, (float)(this.xPosition + this.width) + 0.5F, (float)(this.yPosition + this.height) + 0.5F, (new Color(66, 66, 66)).getRGB());
            RenderUtil.drawRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), -16777216);
         }
         ...
         if (!this.isFocused && this.getText().isEmpty()) {
            this.fontRendererInstance.drawString(this.hoverText, this.xPosition + 5, this.yPosition - this.fontRendererInstance.FONT_HEIGHT / 2 + this.height / 2, (new Color(218, 218, 218)).getRGB());
         }
      }
