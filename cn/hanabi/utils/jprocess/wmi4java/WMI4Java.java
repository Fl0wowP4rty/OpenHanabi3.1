...
public class WMI4Java {
   ...
   public WMI4Java properties(List properties) {
      this.properties = properties;
      return this;
   }

   public WMI4Java filters(List filters) {
      this.filters = filters;
      return this;
   }

   public List listClasses() throws WMIException {
      List wmiClasses = new ArrayList();
   ...
   public List listProperties(String wmiClass) throws WMIException {
      List foundPropertiesList = new ArrayList();
      ...
      try {
         ...
         List notAllowed = Arrays.asList("Equals", "GetHashCode", "GetType", "ToString");
   ...
   public Map getWMIObject(WMIClass wmiClass) {
      return this.getWMIObject(wmiClass.getName());
   }

   public Map getWMIObject(String wmiClass) throws WMIException {
      Map foundWMIClassProperties = new HashMap();
   ...
   public List getWMIObjectList(WMIClass wmiClass) {
      return this.getWMIObjectList(wmiClass.getName());
   }

   public List getWMIObjectList(String wmiClass) throws WMIException {
      List foundWMIClassProperties = new ArrayList();
